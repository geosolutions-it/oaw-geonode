...
COPY src /usr/src/oaw_geonode4/
WORKDIR /usr/src/oaw_geonode4
...
RUN chmod +x /usr/src/oaw_geonode4/tasks.py \
    && chmod +x /usr/src/oaw_geonode4/entrypoint.sh
...
# ENTRYPOINT /usr/src/oaw_geonode4/entrypoint.sh
