...
RUN mkdir -p /usr/src/oaw_geonode
...
COPY . /usr/src/oaw_geonode/
WORKDIR /usr/src/oaw_geonode
...
RUN chmod +x /usr/src/oaw_geonode/tasks.py \
    && chmod +x /usr/src/oaw_geonode/entrypoint.sh
...
ENTRYPOINT /usr/src/oaw_geonode/entrypoint.sh
